...
public class InsertBreak : PageModel
{
    public void OnGet()
    {
    ...
    public InsertBreak(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Group1)
    {
        ...
        FileStream imageStream =
            new FileStream(basePath + @"/images/Word/Mountain-200.jpg", FileMode.Open, FileAccess.Read);
        //Inserting an Image.
