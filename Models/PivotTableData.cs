...
namespace EJ2CoreSampleBrowser.Models
{
    public class PivotTableData
    {
        ...
        public List<VirtualData> GetVirtualData()
        {
            ...
            string[] customername = new string[]{"TOM", "Hawk", "Jon", "Chandler", "Monica", "Rachel", "Phoebe", "Gunther",
        "Ross", "Geller", "Joey", "Bing", "Tribbiani", "Janice", "Bong", "Perk", "Green", "Ken", "Adams"};
            string[] city = new string[]{"New York", "Los Angeles", "Chicago", "Houston", "Philadelphia", "Phoenix", "San Antonio", "Austin",
        "San Francisco", "Columbus", "Washington", "Portland", "Oklahoma", "Las Vegas", "Virginia", "St. Louis", "Birmingham"};
            ...
            for (int i = 1; i < 100001; i++)
            {
                ...
                data.Add(new VirtualData
                {
                    ...
                    Year = random.Next(0, 6) + 2013,
                    CustomerName = customername[random.Next(0, customername.Length)],
                    Price = random.Next(0, 50001) + 5000,
                    Sold = random.Next(0, 81) + 10
                });
            }
            return data;
        }
