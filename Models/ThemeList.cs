...
namespace CoreDemos
{
    public class ThemeList
    {
        ...
        public List<ThemeList> ThemeLists()
        {
            ...
            theme.Add(new ThemeList { Id = "bootstrap5.3", Theme = "Bootstrap 5", Index = 1 });
            theme.Add(new ThemeList { Id = "fluent2", Theme = "Fluent 2", Index = 2 });
            theme.Add(new ThemeList { Id = "tailwind3", Theme = "Tailwind CSS", Index = 3 });
            theme.Add(new ThemeList { Id = "fluent2-highcontrast", Theme = "Fluent 2 High Contrast", Index = 4 });
#endif
            return theme;
        }
    }
