...
public class ConstraintsModel : PageModel
{
    ...
    public void OnGet()
    {
         nodes = new List<DiagramNode>();
            ...
            handle = new List<DiagramUserHandle>();
            ...
            selectedItems.Constraints = SelectorConstraints.UserHandle;
