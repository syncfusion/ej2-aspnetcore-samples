...
public class ContextualTabModel : PageModel
{
    ...
    tableOptions = new List<MenuItem>() { new MenuItem { Text = "Header Row" }, new MenuItem { Text = "Banded Rows" }, new MenuItem { Text = "Banded Columns" }};
    tableItems = new List<MenuItem>() { new MenuItem { Text = "Insert Table" }, new MenuItem { Text = "Draw Table" }, new MenuItem { Text = "Convert Table" }, new MenuItem { Text = "Excel SpreadSheet" } };
    borderItems = new List<MenuItem>() { new MenuItem { Text = "Border Right", IconCss = "e-icons e-border-right" }, new MenuItem { Text = "Border Left", IconCss = "e-icons e-border-left" }, new MenuItem { Text = "Border Bottom", IconCss = "e-icons e-border-bottom" }, new MenuItem { Text = "Border Top", IconCss = "e-icons e-border-top" } };
    mergeItems = new List<MenuItem>() { new MenuItem { Text = "Merge Cells", IconCss = "e-icons e-merge-cells" }, new MenuItem { Text = "Split Cells", IconCss = "e-icons e-split-horizontal" } };
