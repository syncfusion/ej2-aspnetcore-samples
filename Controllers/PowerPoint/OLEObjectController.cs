...
namespace EJ2CoreSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        [HttpPost]
        public ActionResult OLEObject(string button)
        {
            if (button == null)
                return View();
            ...
            {
                FileStream fileStreamInput = new FileStream(basePath + @"/PowerPoint/EmbeddedOleObject.pptx", FileMode.Open, FileAccess.Read);
