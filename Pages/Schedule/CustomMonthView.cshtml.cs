...
public class CustomMonthView : PageModel
{
    public List<CustomMonthData> generateObject()
    {
        ...
        {
            "Story Time for Kids", "Camping with Turtles", "Wildlife Warriors", "Parrot Talk", "Birds of Prey",
            "Croco World",
            "Venomous Snake Hunt", "Face Painting & Drawing events", "Pony Rides", "Feed the Giants",
            "Jungle Treasure Hunt",
            "Endangered Species Program", "Black Cockatoos Playtime", "Walk with Jungle King", "Trained Climbers",
        ...
        for (DateTime start = startDate; start < endDate;)
        {
            ...
            for (int b = 0; b < count; b++)
            {
                ...
                if ((Array.IndexOf(weekEnd, eventStart.DayOfWeek) > -1) ||
                    Array.IndexOf(weekEnd, eventEnd.DayOfWeek) > -1)
                {
                    continue;
                }
