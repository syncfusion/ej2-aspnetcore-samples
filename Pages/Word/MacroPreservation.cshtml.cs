...
public class MacroPreservation : PageModel
{
    ...
    public MacroPreservation(IWebHostEnvironment hostingEnvironment)
    {
    ...
    private MailMergeDataTable GetMailMergeDataTableProductListData()
    {
        ...
        FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/ProductList.xml", FileMode.Open,
            FileAccess.Read);
