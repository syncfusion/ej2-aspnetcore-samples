...
public class FormFillingAndProtection : PageModel
{
    ...
    public FormFillingAndProtection(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public IActionResult OnPost(string Button)
    {
        ...
        textRange.Text = "Launch a website on " + DateTime.Now.AddDays(50).ToShortDateString() +
                         " that allows customers to purchase products online " +
        ...
        //Sets text in rich text content control.
        textRange.Text =
            "By the end of next month, if we do not have a finalized product image, we will not be able to meet our deployment deadline.";
        ApplyCharacterFormat(textRange);
        //Protects the content control.
        inlineControl.ContentControlProperties.LockContents = true;
