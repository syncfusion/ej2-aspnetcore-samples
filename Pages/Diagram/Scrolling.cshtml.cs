...
public class ScrollingModel : PageModel
{
    public List<DiagramNode> basicShapes { get; set; }
    public List<DiagramNode> SymbolPaletee { get; set; }
    public Enum Single { get; set; }
    public List<SymbolPalettePalette> Palette { get; set; }
    public object DropDownModels { get; set; }
    public DiagramGridlines gridLines { get; set; }
    
    public void OnGet()
    {
        basicShapes = new List<DiagramNode>();
            ...
            SymbolPaletee = new List<DiagramNode>();
            ...
            Single = ExpandMode.Single;

            DropDownModel dropDownModel = new DropDownModel();
            DropDownModels = dropDownModel.scrollLimits();
