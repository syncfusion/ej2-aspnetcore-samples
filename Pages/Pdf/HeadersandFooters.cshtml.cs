...
public class HeadersandFooters : PageModel
{
    ...
    public HeadersandFooters(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string InsideBrowser)
    {
        ...
        //Read the file
        FileStream file = new FileStream(dataPath + "Essential studio.txt", FileMode.Open, FileAccess.Read,
            FileShare.ReadWrite);
        ...
        RectangleF column = new RectangleF(0, 20, page.Graphics.ClientSize.Width / 2f - 10f,
        ...
        result.Page.Graphics.DrawString("Essential DocIO", heading, PdfBrushes.DarkBlue,
            new PointF(bounds.X, bounds.Y + image.Height));
        ...
        result.Page.Graphics.DrawString("Essential XlsIO", heading, PdfBrushes.DarkBlue,
            new PointF(bounds.X, bounds.Y + image.Height));
    ...
    private void AddDocumentFooter(PdfDocument doc, string footerText)
    {
        ...
        footer.Graphics.DrawString("Page\tof", font, brush, new RectangleF(0, 0, footer.Width - 8, footer.Height - 8),
            format);
