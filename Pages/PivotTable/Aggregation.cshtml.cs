...
public class Aggregation : PageModel
{
    ...
    public void OnGet()
    {
        ...
        costData.Add(new AggregationDropDownData { Name = "PercentageOfRunningTotals", Value = "% of Running Totals" });
        ...
        unitData.Add(new AggregationDropDownData { Name = "PercentageOfRunningTotals", Value = "% of Running Totals" });
