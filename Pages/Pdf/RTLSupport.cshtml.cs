...
public class RTLSupport : PageModel
{
    public void OnGet()
    {
    ...
    public RTLSupport(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string InsideBrowser)
    {
        ...
        FileStream rtlText =
            new FileStream(dataPath + "arabic.txt", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
