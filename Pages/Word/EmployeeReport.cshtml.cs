...
public class EmployeeReport : PageModel
{
    public void OnGet()
    {
    ...
    public EmployeeReport(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Group1, string Button)
    {
        ...
        string dataPathEmployee = basePath + @"/Word/EmployeesReportDemo.doc";
        ...
        // {
            ...
            string filename = "EmployeeReport.docx";
    ...
    private MailMergeDataTable GetMailMergeDataTableEmployee()
    {
        ...
        FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/EmployeesList.xml", FileMode.Open,
            FileAccess.Read);
