...
var axesData = [
    { xDate: new Date(2013, 0, 29), Open: 85.97, High: 86.37, Low: 85.96, Close: 86.33 },
    { xDate: new Date(2013, 1, 01), Open: 86.1, High: 86.15, Low: 85.9, Close: 86.03 },
    { xDate: new Date(2013, 2, 03), Open: 85.93, High: 86.17, Low: 85.84, Close: 86.02 },
    { xDate: new Date(2013, 3, 05), Open: 85.74, High: 86, Low: 85.66, Close: 86 },
    { xDate: new Date(2013, 4, 07), Open: 85.71, High: 85.71, Low: 85.36, Close: 85.62 },
    { xDate: new Date(2013, 5, 09), Open: 85.3, High: 85.92, Low: 85.16, Close: 85.8 },
    { xDate: new Date(2013, 6, 11), Open: 84.23, High: 85.46, Low: 84.23, Close: 85.2 },
    { xDate: new Date(2013, 7, 13), Open: 84.51, High: 84.54, Low: 84.19, Close: 84.3 },
    { xDate: new Date(2013, 8, 15), Open: 84.44, High: 84.65, Low: 84.2, Close: 84.63 },
    { xDate: new Date(2013, 9, 17), Open: 84.6, High: 84.81, Low: 84.59, Close: 84.65 },
    { xDate: new Date(2013, 10, 19), Open: 84.52, High: 84.86, Low: 84.4, Close: 84.76 },
    { xDate: new Date(2013, 11, 27), Open: 85.97, High: 86.37, Low: 85.96, Close: 86.33 },
    { xDate: new Date(2014, 0, 23), Open: 84.22, High: 84.3, Low: 83.98, Close: 84.26 },
    { xDate: new Date(2014, 1, 25), Open: 83.75, High: 84.1, Low: 83.65, Close: 84 },
    { xDate: new Date(2014, 2, 27), Open: 84, High: 84.01, Low: 83.67, Close: 83.74 },
    { xDate: new Date(2014, 3, 29), Open: 84, High: 84.01, Low: 83.67, Close: 83.74 },
    { xDate: new Date(2014, 4, 01), Open: 84.3, High: 84.45, Low: 84.19, Close: 84.22 },
    { xDate: new Date(2014, 5, 03), Open: 83.79, High: 84.19, Low: 83.7, Close: 84.04 },
    { xDate: new Date(2014, 6, 05), Open: 84.02, High: 84.02, Low: 83.69, Close: 83.71 },
    { xDate: new Date(2014, 7, 07), Open: 84.01, High: 84.04, Low: 83.82, Close: 83.96 },
    { xDate: new Date(2014, 8, 09), Open: 83.9, High: 84.02, Low: 83.86, Close: 83.94 },
    { xDate: new Date(2014, 9, 11), Open: 84.09, High: 84.17, Low: 83.9, Close: 84.06 },
    { xDate: new Date(2014, 10, 13), Open: 83.89, High: 84.25, Low: 83.77, Close: 84.01 },
    { xDate: new Date(2014, 11, 21), Open: 84.17, High: 84.66, Low: 84.16, Close: 84.47 },
    { xDate: new Date(2015, 0, 17), Open: 84.49, High: 84.65, Low: 84.18, Close: 84.22 },
    { xDate: new Date(2015, 1, 19), Open: 84.99, High: 85.1, Low: 84.37, Close: 84.43 },
    { xDate: new Date(2015, 2, 21), Open: 84.96, High: 85.06, Low: 84.7, Close: 85.01 },
    { xDate: new Date(2015, 3, 23), Open: 84.68, High: 84.9, Low: 84.65, Close: 84.76 },
    { xDate: new Date(2015, 4, 25), Open: 84.35, High: 85.03, Low: 84.32, Close: 84.67 },
    { xDate: new Date(2015, 5, 27), Open: 84.19, High: 84.31, Low: 84.16, Close: 84.19 },
    { xDate: new Date(2015, 6, 29), Open: 84.19, High: 84.31, Low: 84.16, Close: 84.19 },
    { xDate: new Date(2015, 7, 01), Open: 84.2, High: 84.29, Low: 84.04, Close: 84.15 },
    { xDate: new Date(2015, 8, 03), Open: 84.21, High: 84.25, Low: 84.03, Close: 84.17 },
    { xDate: new Date(2015, 9, 05), Open: 84.72, High: 84.87, Low: 84.44, Close: 84.49 },
    { xDate: new Date(2015, 10, 07), Open: 84.85, High: 84.88, Low: 84.5, Close: 84.72 },
    { xDate: new Date(2015, 11, 15), Open: 84.05, High: 84.14, Low: 83.84, Close: 83.91 },
    { xDate: new Date(2016, 0, 11), Open: 84.4, High: 84.7, Low: 84.27, Close: 84.52 },
    { xDate: new Date(2016, 1, 13), Open: 84.96, High: 85.07, Low: 84.5, Close: 84.57 },
    { xDate: new Date(2016, 1, 15), Open: 85.28, High: 85.32, Low: 84.95, Close: 85.03 },
    { xDate: new Date(2016, 2, 17), Open: 85.35, High: 85.39, Low: 85.1, Close: 85.32 },
    { xDate: new Date(2016, 3, 19), Open: 85.65, High: 85.66, Low: 85.21, Close: 85.36 },
    { xDate: new Date(2016, 4, 21), Open: 85.38, High: 85.85, Low: 85.25, Close: 85.67 },
    { xDate: new Date(2016, 5, 23), Open: 85.8, High: 85.96, Low: 85.67, Close: 85.83 },
    { xDate: new Date(2016, 6, 25), Open: 86.07, High: 86.22, Low: 85.75, Close: 85.87 },
    { xDate: new Date(2016, 7, 27), Open: 86.05, High: 86.08, Low: 85.68, Close: 85.79 },
    { xDate: new Date(2016, 8, 29), Open: 86.05, High: 86.08, Low: 85.68, Close: 85.79 },
    { xDate: new Date(2016, 9, 01), Open: 85.85, High: 86.25, Low: 85.79, Close: 86.06 },
    { xDate: new Date(2016, 10, 03), Open: 85.6, High: 85.85, Low: 85.49, Close: 85.81 },
    { xDate: new Date(2016, 11, 09), Open: 84.53, High: 84.74, Low: 84.25, Close: 84.69 },
    { xDate: new Date(2017, 0, 07), Open: 86.55, High: 86.64, Low: 85.36, Close: 85.92 },
    { xDate: new Date(2017, 1, 09), Open: 86.46, High: 86.87, Low: 86.4, Close: 86.71 },
    { xDate: new Date(2017, 2, 11), Open: 86.3, High: 86.39, Low: 86.13, Close: 86.38 },
    { xDate: new Date(2017, 3, 13), Open: 85.74, High: 86.44, Low: 85.67, Close: 86.19 },
    { xDate: new Date(2017, 4, 15), Open: 85.56, High: 85.62, Low: 85.34, Close: 85.61 },
    { xDate: new Date(2017, 5, 17), Open: 85.79, High: 85.89, Low: 85.36, Close: 85.52 },
    { xDate: new Date(2017, 6, 19), Open: 85.54, High: 86, Low: 85.51, Close: 85.76 },
    { xDate: new Date(2017, 7, 21), Open: 85, High: 85.17, Low: 84.87, Close: 85.15 },
    { xDate: new Date(2017, 8, 23), Open: 85.1, High: 85.28, Low: 84.72, Close: 85.08 },
    { xDate: new Date(2017, 9, 25), Open: 85.46, High: 85.56, Low: 85.18, Close: 85.37 },
    { xDate: new Date(2017, 10, 27), Open: 85.42, High: 85.44, Low: 85.09, Close: 85.42 },
    { xDate: new Date(2017, 11, 05), Open: 85.94, High: 86, Low: 85.48, Close: 85.66 }
];
