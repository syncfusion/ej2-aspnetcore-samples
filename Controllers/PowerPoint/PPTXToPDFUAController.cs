...
namespace EJ2CoreSampleBrowser.Controllers
{
    ...
    {
        public IActionResult PPTXToPDFUA()
        {
            return View();
        }
    
        [HttpPost]
        public ActionResult PPTXToPDFUA(string button, string view)
        {
            if (button == null)
                return View();
            ...
            if (stream != null)
            {
                try
                {
                    string output = (Request.Form.Files != null && Request.Form.Files.Count != 0) ? Path.GetFileNameWithoutExtension(Request.Form.Files[0].FileName) : "PPTXToPDF_Pdf_UA";
