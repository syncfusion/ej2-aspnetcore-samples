...
public class Comment : PageModel
{
    ...
    public Comment(IWebHostEnvironment hostingEnvironment)
    {
    ...
    private void SlideWithComments(IPresentation presentation)
    {
        ...
        IComment comment = slide1.Comments.Add(0.5, 0.04, "Author1", "A1",
            "Essential Presentation is available from 13.1 versions of Essential Studio", DateTime.Now);
        //Author2 add reply to a parent comment
        slide1.Comments.Add("Author2", "A2", "Does it support rendering of slides as images or PDF?", DateTime.Now,
            comment);
        ...
        slide2.Comments.Add(0.35, 0.04, "Author2", "A2", "Do all 3D-chart types support in Presentation library?",
            DateTime.Now);
