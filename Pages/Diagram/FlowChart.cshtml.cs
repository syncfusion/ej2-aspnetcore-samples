...
public class FlowChartModel : PageModel
{
    ...
    public List<ContextMenuItem> alignItems { get; set; }
    public List<ContextMenuItem> distributeItems { get; set; }
    public List<ContextMenuItem> orderItems { get; set; }
    public List<ContextMenuItem> groupItems { get; set; }
    public List<ContextMenuItem> rotateItems { get; set; }
    public List<ContextMenuItem> flipItems { get; set; }
    public List<ContextMenuItem> zoomMenuItems { get; set; }
    ...
    public void OnGet()
    {
        Nodes = new List<DiagramNode>();
            ...
            alignItems = new List<ContextMenuItem>();
            {
            ...
            distributeItems = new List<ContextMenuItem>();
            {
            ...
            orderItems = new List<ContextMenuItem>();
            {
            ...
            groupItems = new List<ContextMenuItem>();
            {
            ...
            rotateItems = new List<ContextMenuItem>();
            {
            ...
            flipItems = new List<ContextMenuItem>();
            {
            ...
            zoomMenuItems = new List<ContextMenuItem>();
            {
