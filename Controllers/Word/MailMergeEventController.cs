    ...
    {       
        ...
        private void MergeField_ProductImage(object sender, MergeImageFieldEventArgs args)
        {
            ...
            if (args.FieldName == "ProductImage")
            {
                ...
                FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/images/Word/"+ ProductFileName, FileMode.Open, FileAccess.Read);
                args.ImageStream = fs;
            }
        }
        ...
        private MailMergeDataTable GetMailMergeDataTablePriceList()
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/ProductPriceList.xml", FileMode.Open, FileAccess.Read);
        ...
        private MailMergeDataTable GetMailMergeDataTableProductData()
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/Product.xml", FileMode.Open, FileAccess.Read);
            XmlReader reader = XmlReader.Create(fs);
            if (reader == null)
                throw new Exception("reader");
            while (reader.NodeType != XmlNodeType.Element)
