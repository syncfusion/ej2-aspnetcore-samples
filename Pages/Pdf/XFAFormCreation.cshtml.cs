...
public class XFAFormCreation : PageModel
{
    public void OnGet()
    {
    ...
    public ActionResult OnPost(string Browser)
    {
        ...
        {
            HorizontalAlignment = PdfXfaHorizontalAlignment.Center, VerticalAlignment = PdfXfaVerticalAlignment.Middle,
            Width = page.GetClientSize().Width, Height = 60
        };
        ...
        PdfXfaRectangleField rectangle = new PdfXfaRectangleField("rect", new SizeF(60, 1.2f))
            { Visibility = PdfXfaVisibility.Invisible };
        ...
        fileStreamResult.FileDownloadName = "XFAFormCreation.pdf";
