...
{
    public object CirclePaletteColors { get; set; }
    public object SquarePaletteColors { get; set; }
    public object RoundedPaletteColors { get; set; }
    public object ScrollPaletteColors { get; set; }
    ...
    public void OnGet()
    {
        ...
        CirclePaletteColors = custom[0];
        SquarePaletteColors = custom[1];
        RoundedPaletteColors = custom[2];
        ScrollPaletteColors = custom[3];
    }
}