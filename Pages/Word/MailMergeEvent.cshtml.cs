...
public class MailMergeEvent : PageModel
{
    public void OnGet()
    {
    ...
    public MailMergeEvent(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Group1, string Button)
    {
        ...
        string dataPath = basePath + @"/Word/MailMergeEventTemplate.doc";
        ...
        // {
            ...
            string filename = "MailMergeEvent.docx";
    ...
    private void MergeField_ProductImage(object sender, MergeImageFieldEventArgs args)
    {
        ...
        if (args.FieldName == "ProductImage")
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/images/Word/" + ProductFileName,
    ...
    private MailMergeDataTable GetMailMergeDataTablePriceList()
    {
        ...
        FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/ProductPriceList.xml", FileMode.Open,
            FileAccess.Read);
    ...
    private MailMergeDataTable GetMailMergeDataTableProductData()
    {
        ...
        FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/Product.xml", FileMode.Open,
            FileAccess.Read);
        XmlReader reader = XmlReader.Create(fs);
        if (reader == null)
            throw new Exception("reader");
