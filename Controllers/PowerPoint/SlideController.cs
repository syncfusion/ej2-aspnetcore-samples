...
namespace EJ2CoreSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Slide(string button)
        {
            if (button == null)
                return View();
            string basePath = _hostingEnvironment.WebRootPath;
            FileStream fileStreamInput = new FileStream(basePath + @"/PowerPoint/Slides.pptx", FileMode.Open, FileAccess.Read);
        ...
        private void CreateThirdSlide(IPresentation presentation)
        {
            ...
            string basePath = _hostingEnvironment.WebRootPath;
            FileStream imageStream = new FileStream(basePath + @"/PowerPoint/tablet.jpg", FileMode.Open, FileAccess.Read);
