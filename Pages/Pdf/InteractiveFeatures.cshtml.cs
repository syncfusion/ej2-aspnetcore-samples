...
public class InteractiveFeatures : PageModel
{
    ...
    public InteractiveFeatures(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string InsideBrowser)
    {
        ...
        g.DrawString("Invoice", new PdfStandardFont(PdfFontFamily.TimesRoman, 24), PdfBrushes.White,
            new PointF(500, 10));
        ...
        //Read the file
        FileStream file = new FileStream(dataPath + "AdventureCycle.jpg", FileMode.Open, FileAccess.Read,
            FileShare.ReadWrite);
        ...
        g.DrawString("Invoice No: " + invoiceNumber.Next().ToString(), new PdfStandardFont(PdfFontFamily.Helvetica, 14),
            new PdfSolidBrush(maroonColor), new PointF(50, 210));
        g.DrawString("Date: ", new PdfStandardFont(PdfFontFamily.Helvetica, 14), new PdfSolidBrush(maroonColor),
            new PointF(350, 210));
        ...
        g.DrawRectangle(new PdfSolidBrush(Syncfusion.Drawing.Color.FromArgb(238, 238, 238, 248)),
            new RectangleF(50, 240, 500, 140));
        ...
        g.DrawString("Grand Total:", new PdfStandardFont(PdfFontFamily.Helvetica, 12),
            new PdfSolidBrush(Syncfusion.Drawing.Color.FromArgb(255, 255, 167, 73)),
            new PointF(result.Bounds.Right - 150, result.Bounds.Bottom));
        CreateTextBox(interactivePage, "GrandTotal", "Grand Total",
            new RectangleF(result.Bounds.Width - 15, result.Bounds.Bottom - 2, 66, 18), true, "");
        ...
        openSpecificationButton.Actions.MouseUp =
            new PdfJavaScriptAction("this.exportDataObject({ cName: 'Product Catalog.pdf', nLaunch: 2 });");
        document.Form.Fields.Add(openSpecificationButton);

        RectangleF uriAnnotationRectangle = new RectangleF(interactivePage.Graphics.ClientSize.Width - 160,
            interactivePage.Graphics.ClientSize.Height - 30, 80, 20);
        ...
        g.DrawRectangle(purpleBrush,
            new RectangleF(0, interactivePage.Graphics.ClientSize.Height - 100,
                interactivePage.Graphics.ClientSize.Width, 100));
        g.DrawPie(whitePen, whiteBrush, new RectangleF(-20, interactivePage.Graphics.ClientSize.Height - 250, 700, 200),
            0, 180);
    ...
    void table_BeginCellLayout(object sender, BeginCellLayoutEventArgs args)
    {
        ...
        {
            CreateTextBox(interactivePage, "TotalPrice" + args.RowIndex.ToString(), "Total Price", args.Bounds, true,
                "0");
        }
    }
    /// <summary>
