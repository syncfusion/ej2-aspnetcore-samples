    ...
    public class UserTokenService
    {
        ...
        public async Task<string> ReturnAlertMessage(string userCode)
        {
            ...
            if (tokenData.ContainsKey(userCode))
            {
                ...
                var message = $"You have reached your token limit. Your tokens will reset on {resetTime}. Download our <a href=\"https://github.com/syncfusion/ej2-aspnetcore-samples.git\" target=\"_blank\">Syncfusion AspNet Core Samples</a> from GitHub to explore this sample locally with your own API key.";
                return message;
            }
            return "";
        }
