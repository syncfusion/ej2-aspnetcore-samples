...
public class Forms : PageModel
{
    ...
    public Forms(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Group1)
    {
        ...
        FileStream imageStream = new FileStream(basePath + @"/images/Word/Image.jpg", FileMode.Open, FileAccess.Read);
