...
namespace EJ2CoreSampleBrowser.Controllers.PDF
{
    public partial class PdfController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AnnotationFlatten(string InsideBrowser, string checkboxFlatten, string submit, IFormFile file)
        {
            if(submit == "Create Annotations")
            {
                ...
                Stream filestream = new FileStream(dataPath + "Video.mp4", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
                ...
                Stream imageStream = new FileStream(dataPath + "richmedia.jpg", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
                ...
                Stream soundImageStream = new FileStream(dataPath + "richmedia_sound.jpg", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
