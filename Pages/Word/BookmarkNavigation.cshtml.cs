...
public class BookmarkNavigation : PageModel
{
    public void OnGet()
    {
    ...
    public BookmarkNavigation(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Group1, string Button)
    {
        ...
        FileStream imageStream =
            new FileStream(basePath + @"/images/Word/Northwind.png", FileMode.Open, FileAccess.Read);
