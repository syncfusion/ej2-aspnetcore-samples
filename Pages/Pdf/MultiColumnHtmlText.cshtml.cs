...
public class MultiColumnHtmlText : PageModel
{
    public void OnGet()
    {
    ...
    public MultiColumnHtmlText(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string InsideBrowser)
    {
        ...
        FileStream fontstream =
            new FileStream(dataPath + "Calibri.ttf", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
        ...
        FileStream imageStream =
            new FileStream(dataPath + "PDFImage.png", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
        ////Drawing Image
        ...
        FileStream gifStream =
            new FileStream(dataPath + "Essen PDF.gif", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
        ////Drawing Image
        PdfImage image1 = new PdfTiffImage(gifStream);
        page.Graphics.DrawImage(image1, new RectangleF(310, 80, 180, 110));
        ...
        htmlText =
            "<p>Every Syncfusion license includes a <i>one-year subscription</i> for unlimited technical support and new releases." +
        ...
        htmlText =
            "Each licensed control would need to have an entry in the licx file. This would mean that if you were using 20 licensed controls, you would have 20 different entries complete with a full version number in your licx file." +
    ...
    private void AddMulticolumnHeader(PdfDocument doc, string title, string description)
    {
        ...
        //Draw description
        header.Graphics.DrawString(description, font, brush, new RectangleF(0, 0, header.Width, header.Height - 8),
            format);
