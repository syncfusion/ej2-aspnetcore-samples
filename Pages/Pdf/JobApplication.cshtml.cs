...
public class JobApplication : PageModel
{
    public void OnGet()
    {
    ...
    public JobApplication(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Browser)
    {
        ...
        pdfDoc.Pages[0].Graphics.DrawString("General Information", pdfFont,
            new PdfSolidBrush(new PdfColor(213, 123, 19)), 25, 40);
        pdfDoc.Pages[0].Graphics.DrawString("Education Grade", pdfFont, new PdfSolidBrush(new PdfColor(213, 123, 19)),
            25, 190);

        pdfFont = new PdfStandardFont(PdfFontFamily.Helvetica, 10);
        //Create fields in first page.
        pdfDoc.Pages[0].Graphics
            .DrawString("First Name:", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 65);
        ...
        pdfDoc.Pages[0].Graphics
            .DrawString("Last Name:", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 83);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("Business Phone:", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)),
            25, 123);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("Which position are\nyou applying for?", pdfFont,
            new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 143);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("Highest qualification", pdfFont,
            new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 217);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("Associate degree", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)),
            bounds.X, bounds.Y);
        bounds.X += 90;
        ...
        pdfDoc.Pages[0].Graphics.DrawString("Bachelor degree", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)),
            bounds.X, bounds.Y);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("College", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)),
            bounds.X, bounds.Y);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("Post Graduate", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)),
            bounds.X, bounds.Y);
        ...
        pdfDoc.Pages[0].Graphics.DrawString("MBA", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), bounds.X,
            bounds.Y);
        ...
        submitButton.Bounds = new RectangleF(pdfDoc.Pages[0].GetClientSize().Width - 20,
            pdfDoc.Pages[0].GetClientSize().Height - 25, 20, 20);
        ...
        pdfDoc.Pages[1].Graphics.DrawString("Current position",
            new PdfStandardFont(PdfFontFamily.TimesRoman, 10, PdfFontStyle.Bold),
            new PdfSolidBrush(new PdfColor(213, 123, 19)), 25, 40);
        ...
        pdfDoc.Pages[1].Graphics.DrawString("I am not currently employed", pdfFont,
            new PdfSolidBrush(new PdfColor(124, 143, 166)), bounds.X, bounds.Y);

        bounds.X += 90;
        pdfDoc.Form.Fields.Add(chb);

        //Add fileds in second page
        pdfDoc.Pages[1].Graphics
            .DrawString("Job Title", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 85);
        ...
        pdfDoc.Pages[1].Graphics
            .DrawString("Employer:", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 103);
        ...
        pdfDoc.Pages[1].Graphics.DrawString("Reason for leaving:", pdfFont,
            new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 123);
        ...
        pdfDoc.Pages[1].Graphics.DrawString("Total Annual salary:", pdfFont,
            new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 143);
        ...
        pdfDoc.Pages[1].Graphics
            .DrawString("Duties:", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 168);
        ...
        pdfDoc.Pages[1].Graphics.DrawString("Employment type:", pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)),
            25, 268);
        ...
        submitButton.Bounds = new RectangleF(pdfDoc.Pages[1].GetClientSize().Width - 20,
            pdfDoc.Pages[1].GetClientSize().Height - 25, 20, 20);
        submitButton.Font = pdfFont;
        ...
        pdfDoc.Pages[2].Graphics
            .DrawString("Thank You", pdfFont, new PdfSolidBrush(new PdfColor(213, 123, 19)), 25, 80);
        ...
        pdfDoc.Pages[2].Graphics
            .DrawString("Thanks for taking the time to complete this form.\nWe will be in contact with you shortly.",
                pdfFont, new PdfSolidBrush(new PdfColor(124, 143, 166)), 25, 110);
