...
namespace EJ2CoreSampleBrowser.Controllers.Word
{
    ...
    {
        #region SplitByBookmark
        public ActionResult SplitByBookmark(string Group1, string Button, string ExcludeLabelsAndNumbers)
        {
            if (Group1 == null)
                return View();
            ...
            string outputFileName = (Request.Form.Files != null && Request.Form.Files.Count != 0) ? Request.Form.Files[0].FileName : "SplitByBookmark.docx";
        ...
        private Stream GetBookmarkWordDocument()
        {
            ...
            else
            {
                ...
                FileStream fileStreamPath = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/SplitByBookmark.docx", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
