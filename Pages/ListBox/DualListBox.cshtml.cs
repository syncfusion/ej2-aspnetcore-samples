...
namespace EJ2CoreSampleBrowser_NET8.Pages.ListBox;

public class DualListBoxModel : PageModel
{
    ...
    public void OnGet()
    {
        ...
        Items = new string[] { "moveUp", "moveDown", "moveTo", "moveFrom", "moveAllTo", "moveAllFrom" };
    }
}