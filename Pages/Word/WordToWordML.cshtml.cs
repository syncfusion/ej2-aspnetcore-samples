...
public class WordToWordML : PageModel
{
    public void OnGet()
    {
    ...
    public ActionResult OnPost(string button)
    {
        ...
        if (Request.Form.Files != null)
        {
            ...
            {
                Message = string.Format("Please choose Word format document to convert to WordML");
            }
        }
        else
        {
            Message =
                string.Format("Browse a Word document and then click the button to convert as a WordML document");
        }
