...
namespace EJ2CoreSampleBrowser.Controllers.Word
{
    ...
    {
        #region SplitByPlaceholder
        public ActionResult SplitByPlaceholder(string Group1, string Button, string RegexPattern, string IncludePlaceholder)
        {
            if (Group1 == null)
                return View();
            ...
            string outputFileName = (Request.Form.Files != null && Request.Form.Files.Count != 0) ? Request.Form.Files[0].FileName : "SplitByPlaceholder.docx";
            ...
            if (fileStream != null)
            {
                try
                {
                    ...
                    using (WordDocument document = new WordDocument(fileStream, FormatType.Docx))
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                return File(memoryStream, "application/pdf", Path.GetFileNameWithoutExtension(outputFileName) + ".pdf");
                            }
                        }
                        #endregion
                        fileStream.Dispose();
                    ...
                    string outpurFileNmae = Group1 == "WordDocx" ? "SplitByPlaceholderDOCX.zip" : "SplitByPlaceholderPDFs.zip";
        ...
        private Stream GetPlaceholderWordDocument()
        {
            ...
            else
            {
                ...
                FileStream fileStreamPath = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/SplitByPlaceholder.docx", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
