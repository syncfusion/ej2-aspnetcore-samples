...
{
    public class FormControls : PageModel
    {
        private readonly IWebHostEnvironment _hostingEnvironment;
        private Color color1;
        private string[] onlinePayments;
        public FormControls(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public ActionResult OnPost(string SaveOption)
        {
            ...
            string dataPathTemp = basePath + @"/images/XlsIO/contact_sales.gif";
            if (SaveOption == null)
                return null;
            ...
            FileStream imageStream = new FileStream(dataPathTemp , FileMode.Open, FileAccess.Read);
