...
public class Attachments : PageModel
{
    public void OnGet()
    {
    ...
    public Attachments(IWebHostEnvironment hostingEnvironment)
    {
        _hostingEnvironment = hostingEnvironment;
    }
    [HttpPost]
    public ActionResult OnPost(string encrypt, string password)
    {
        ...
        //Draw the text
        page.Graphics.DrawString("Attachments", font, PdfBrushes.Black,
        ...
        page.Graphics.DrawString("This PDF document contains image and text file as attachment.", font,
            PdfBrushes.Black, new PointF(0, 30));
        ...
        openSpecificationButton.Actions.MouseUp =
            new PdfJavaScriptAction("this.exportDataObject({ cName: 'Autumn Leaves.jpg', nLaunch: 2 });");
        ...
        openSpecificationButton.Actions.MouseUp =
            new PdfJavaScriptAction("this.exportDataObject({ cName: 'Text1.txt', nLaunch: 2 });");
        doc.Form.Fields.Add(openSpecificationButton);
