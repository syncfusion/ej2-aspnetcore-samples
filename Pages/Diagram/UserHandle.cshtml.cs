...
public class UserHandleModel : PageModel
{
    ...
    public List<DiagramNodeFixedUserHandle> handle { get; set; }
    
    public void OnGet()
    
        {
            handle = new List<DiagramNodeFixedUserHandle>();
            handle.Add(new DiagramNodeFixedUserHandle() {
            Width=20,
            Height=20,
            Offset = new DiagramPoint() { X = 1.1, Y = 0.5 } 
