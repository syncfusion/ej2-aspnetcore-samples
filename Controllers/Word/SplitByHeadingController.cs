...
namespace EJ2CoreSampleBrowser.Controllers.Word
{
    ...
    {
        #region SplitByHeading
        public ActionResult SplitByHeading(string Group1, string Button, string ExcludeLabelsAndNumbers)
        {
            if (Group1 == null)
                return View();
            ...
            string outputFileName = (Request.Form.Files != null && Request.Form.Files.Count != 0) ? Request.Form.Files[0].FileName : "SplitByHeading.docxx";
                    ...
                    using (WordDocument document = new WordDocument(fileStream, FormatType.Docx))
                    {
                        ...
                        if (newDocument == null && headingIndex == 0)
                        {
                            ...
                            else
                            {
                                ...
                                return File(documentStream, "application/pdf", Path.GetFileNameWithoutExtension(outputFileName) + ".pdf");
                            }
                        }
        ...
        private Stream GetHeadingWordDocument()
        {
            ...
            else
            {
                ...
                FileStream fileStreamPath = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/SplitByHeading.docx", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
