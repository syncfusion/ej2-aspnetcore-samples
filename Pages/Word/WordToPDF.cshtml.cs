...
public class WordToPDF : PageModel
{
    ...
    public WordToPDF(IWebHostEnvironment hostingEnvironment)
    {
        _hostingEnvironment = hostingEnvironment;
    }

    public IActionResult OnPost(string button, string renderingMode1, string renderingMode2, string renderingMode3,
        string renderingMode4)
    {
        if (button == null)
            return null;
        // return View();
        ...
        if (stream != null)
        {
            try
            {
                ...
                if (renderingMode3 == "ShowRevisions")
                {
                    ...
                    document.RevisionOptions.ShowMarkup =
                        RevisionType.Deletions | RevisionType.Formatting | RevisionType.Insertions;
    ...
    private Stream GetWordDocument()
    {
        ...
        else
        {
            ...
            FileStream fileStreamPath = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/WordtoPDF.docx",
