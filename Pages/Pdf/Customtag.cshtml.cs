...
public class Customtag : PageModel
{
    ...
    public Customtag(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Browser)
    {
        ...
        FileStream fileStream1 =
            new FileStream(dataPath + "CustomTag.jpg", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
        ...
        PdfTextElement headerElement1 =
            new PdfTextElement("Chapter 1 Conceptual Overview", fontTitle, PdfBrushes.Black);
