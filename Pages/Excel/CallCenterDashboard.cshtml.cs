...
{
    public class CallCenterDashboard : PageModel
    {
        private readonly IWebHostEnvironment _hostingEnvironment;
        public CallCenterDashboard(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public ActionResult OnPost(string button)
        {
            ...
            {
                Stream ms = new FileStream(basePath + @"/XlsIO/CallCenterTemplate.xlsx", FileMode.Open, FileAccess.Read);
            ...
            else
            {
                ...
                try
                {
                    ...
                    return File(ms, "Application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "CallCenterDashboard.xlsm");
                }
                catch (Exception)
                {
                }
