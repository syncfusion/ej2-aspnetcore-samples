...
xcopy /q /y "wwwroot\css\pdfviewer\images\employees\" "PDF\wwwroot\css\pdfviewer\images\employees\"
...
xcopy /q /y  "Pages\Uploader" "PDF\Pages\Uploader\"
xcopy /q /y  "Pages\Pdf\Zugferd" "PDF\Pages\Pdf\Zugferd\"
xcopy /q /y  "Pages\Dialog\ComponentsDialog.cshtml.cs" "PDF\Pages\Dialog\"
...
xcopy  /q /y  "Pages\ThemeList.cs" "PDF\Pages\"
xcopy  /q /y  "Models\OrdersDetails.cs" "PDF\Models\"
xcopy  /q /y  "Models\GameList.cs" "PDF\Models\"
xcopy  /q /y  "Models\ScheduleEvents.cs" "PDF\Models\"
xcopy  /q /y  "Models\PdfDocumentList.cs" "PDF\Models\"
xcopy /q /y  "Pages" "PDF\Pages\"
xcopy /q /y  "Pages\Shared\_Layout.cshtml" "PDF\Pages\Shared\"
xcopy /q /y  "Pages\Pdf" "PDF\Pages\Pdf\"
xcopy /q /y  "Pages\Dialog\ComponentsDialog.cshtml" "PDF\Pages\Dialog\"
...
@echo off
set "destinationFile=PDF\Pages\index.cshtml.cs"
set "searchWord=/grid/gridoverview"
set "replaceWord=/pdf/default"
