...
public class BulletsandLists : PageModel
{
    ...
    public BulletsandLists(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string InsideBrowser)
    {
        ...
        string[] products =
            { "Tools", "Grid", "Chart", "Edit", "Diagram", "XlsIO", "Grouping", "Calculate", "PDF", "HTMLUI", "DocIO" };
        ...
        graphics.DrawString(
            ...
            new RectangleF(0, 50, page.Graphics.ClientSize.Width, page.Graphics.ClientSize.Height));
