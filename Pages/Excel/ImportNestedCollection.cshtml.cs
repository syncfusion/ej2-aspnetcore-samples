...
namespace EJ2CoreSampleBrowser_NET8.Pages.Excel
{
    public class ImportNestedCollection : PageModel
    {
        ...
        public ImportNestedCollection(IWebHostEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }
        public ActionResult OnPost(string LayoutOptions, string button, string checkbox, string rdb1, string textBox)
        {
