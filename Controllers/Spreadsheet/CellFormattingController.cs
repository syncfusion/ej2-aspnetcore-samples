    ...
    public partial class SpreadsheetController : Controller
    {
        public IActionResult CellFormatting()
        {
            List<object> orderDetails = new List<object>()
            {
                ...
                new { OrderID= 10257, CustomerName= "Michael Holz", OrderDate= "07-09-1996", Address= "Carrera 22 con Ave. Carlos Soublette", City= "San Cristóbal", PostalCode= "5022", Country= "Venezuela", Status= "Delivered", Freight= "81.91"},
                new { OrderID= 10258, CustomerName= "Roland Mendel", OrderDate= "07-03-1996", Address= "Kirchgasse 6", City= "Graz", PostalCode= "8010", Country= "Austria", Status= "Cancelled", Freight= "140.51"},
