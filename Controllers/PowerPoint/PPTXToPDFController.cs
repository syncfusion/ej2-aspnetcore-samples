...
namespace EJ2CoreSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        [HttpPost]
        public ActionResult PPTXToPDF(string Browser, string view, string renderingMode)
        {
            ...
            if (stream != null)
            {
                try
                {
                    string output = (Request.Form.Files != null && Request.Form.Files.Count != 0) ? Path.GetFileNameWithoutExtension(Request.Form.Files[0].FileName) : "PPTXToPDF";
                    ...
                    if (renderingMode == "PreserveStructureTags")
