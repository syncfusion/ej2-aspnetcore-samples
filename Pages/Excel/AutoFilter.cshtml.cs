...
{
    public class AutoFilter : PageModel
    {
        public List<icons> DataSource= icons.GetSymbols();
        public List<icons> DataSource2= icons.GetRating();
        public List<icons> DataSource3 = icons.GetArrows();
        private readonly IWebHostEnvironment _hostingEnvironment;
        public AutoFilter(IWebHostEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }
        public ActionResult OnPost(string id, string FilterType, string button, string colorsList, string rdb1, string rdb3, string iconText, string iconSetTypeList, string field, string checkbox)
        {
