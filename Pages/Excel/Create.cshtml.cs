...
namespace EJ2CoreSampleBrowser_NET8.Pages.Excel
{
    public class Create : PageModel
    {
        ...
        public Create(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public ActionResult OnPost(string saveOption) 
        {
            ...
            if (saveOption == "CSV" || saveOption == "TSV")
            {
