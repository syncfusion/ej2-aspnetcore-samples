...
public class LetterFormat : PageModel
{
    public void OnGet()
    {
    ...
    public LetterFormat(IWebHostEnvironment hostingEnvironment)
    {
        _hostingEnvironment = hostingEnvironment;
    }

    public ActionResult OnPost(string Group1, string Button, string MapDataField)
    {
