...
{
    public List<PortVisibilityList> portvisibility { get; set; }
    public List<ShapeList> shape { get; set; }
    ...
    public void OnGet()
    {
        List<DiagramNodeAnnotation> Node1 = new List<DiagramNodeAnnotation>();
           ...
           Connectors = new List<DiagramConnector>();
            ...
            portvisibility = new List<PortVisibilityList>();
