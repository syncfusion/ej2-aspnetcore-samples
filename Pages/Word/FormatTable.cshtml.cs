...
public class FormatTable : PageModel
{
    public void OnGet()
    {
    ...
    public FormatTable(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Group1)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            switch (i)
            {
                case 0:
                    ...
                    row.Cells[i].Width = 50f;
                    break;
                case 1:
                    text = paragraph.AppendText("Drinks");
                    break;
                case 2:
                    text = paragraph.AppendText("Showcase Image");
                    row.Cells[i].Width = 200f;
                    break;
            }
        ...
        FileStream imageStream =
            new FileStream(basePath + @"/images/Word/Apple Juice.png", FileMode.Open, FileAccess.Read);
