...
public class CreateSmartArt : PageModel
{
    private readonly IWebHostEnvironment _hostingEnvironment;
    public CreateSmartArt(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public IActionResult OnPost(string SmartArtType)
    {
        string basePath = _hostingEnvironment.WebRootPath;
        string dataPath = basePath + @"/Word/CreateSmartArtInput.docx";
    ...
    private void CreatePictureSmartArt(WordDocument document, string basePath)
    {
        ...
        AddPicture(employeeNode1, basePath + @"/images/Word/Nancy Davolio.png");
        ...
        AddPicture(employeeNode2, basePath + @"/images/Word/Andrew Fuller.png");
        ...
        AddPicture(employeeNode3, basePath + @"/images/Word/Janet Leverling.png");
    }
