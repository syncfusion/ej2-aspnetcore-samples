...
public class HelloWorld : PageModel
{
    ...
    public HelloWorld(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public IActionResult OnPost(string Group1)
        {
            if (Group1 == null)
                return null;
            ...
            FileStream imageStream = new FileStream(basePath + @"/images/Word/AdventureCycle.jpg", FileMode.Open, FileAccess.Read);
            ...
            imageStream = new FileStream(basePath + @"/images/Word/Mountain-200.jpg", FileMode.Open, FileAccess.Read);
