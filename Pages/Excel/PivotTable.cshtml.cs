...
namespace EJ2CoreSampleBrowser.Pages.Excel
{
    public class PivotTable : PageModel
    {
        ...
        public PivotTable(IWebHostEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }
        public ActionResult OnPost(string button, string Filter, string RowFilter, string ColumnFilter, string ApplyGrouping, string MultiplePageFilter, string PageFilter)
        {
            if (button == null)
                return null;
