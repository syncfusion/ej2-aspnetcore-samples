...
public class Autotag : PageModel
{
    public void OnGet()
    {
    ...
    public Autotag(IWebHostEnvironment hostingEnvironment)
    {
    ...
    public ActionResult OnPost(string Browser)
    {
        ...
        FileStream fileStream1 =
            new FileStream(dataPath + "AutoTag.jpg", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
        ...
        page2.Graphics.DrawLine(new PdfPen(PdfBrushes.Black, 0.5f), new PointF(0, 40),
            new PointF(page2.GetClientSize().Width, 40));

        page2.Graphics.DrawString(
            "Chapter 1 Introducing C# and .NET .............................................................................................................. 3 \r\n ",
        ...
        page3.Graphics.DrawString("C# Succinctly", new PdfTrueTypeFont(stream, 32), PdfBrushes.Black,
            new PointF(160, 0));

        page3.Graphics.DrawLine(PdfPens.Black, new PointF(0, 40), new PointF(page3.GetClientSize().Width, 40));

        page3.Graphics.DrawString("Chapter 1 Introducing C# and .NET", fontTitle, PdfBrushes.Black,
            new PointF(160, 60));
        ...
        page3.Graphics.DrawString("Writing, Running, and Deploying a C# Program", fontHead2, PdfBrushes.Black,
            new PointF(0, 520));
        ...
        FileStream fileStream2 = new FileStream(dataPath + "autotagSmall.jpg", FileMode.Open, FileAccess.Read,
            FileShare.ReadWrite);
        PdfBitmap img = new PdfBitmap(fileStream2);
        page3.Graphics.DrawImage(img, new PointF(0, 630));
        page3.Graphics.DrawString("Note: The code samples in this book can be downloaded at", fontnormal,
            PdfBrushes.DarkBlue, new PointF(20, 630));
        page3.Graphics.DrawString("https://bitbucket.org/syncfusiontech/c-succinctly", fontnormal, PdfBrushes.Blue,
            new PointF(20, 640));
        ...
        PdfUriAnnotation uriAnnotation =
            new PdfUriAnnotation(rectangle, "https://bitbucket.org/syncfusiontech/c-succinctly");
