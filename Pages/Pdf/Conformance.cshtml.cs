...
public class Conformance : PageModel
{
    public string[] data;
    public void OnGet()
    {
        data = new string[]
        {
            "PDF/A-1a", "PDF/A-1b", "PDF/A-2a", "PDF/A-2b", "PDF/A-2u", "PDF/A-3a", "PDF/A-3b", "PDF/A-3u", "PDF/A-4",
            "PDF/A-4e", "PDF/A-4f"
        };
    }
    private readonly IWebHostEnvironment _hostingEnvironment;
    public Conformance(IWebHostEnvironment hostingEnvironment)
    {
        _hostingEnvironment = hostingEnvironment;
    }
    
    [HttpPost]
    public ActionResult OnPost(string InsideBrowser, string conformance)
    {
        ...
        else
        {
            ...
            //Read the file
            FileStream file = new FileStream(dataPath + "Text1.txt", FileMode.Open, FileAccess.Read,
                FileShare.ReadWrite);
        ...
        PdfLayoutResult layoutResult = textElement.Draw(page,
            new RectangleF(0, 150, page.GetClientSize().Width, page.GetClientSize().Height));
