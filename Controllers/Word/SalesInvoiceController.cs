...
{   
    ...
    {    
        public ActionResult SalesInvoice(int id, string SaveOption, string Button)
        {
            ...
            string dataPath = basePath + @"/Word/SalesInvoiceDemo.doc";
        ...
        private MailMergeDataTable GetTestOrder(int TestOrderId)
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/TestOrder.xml", FileMode.Open, FileAccess.Read); 
        ...
        private MailMergeDataTable GetTestOrderDetails(int TestOrderId)
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/TestOrderDetails.xml", FileMode.Open, FileAccess.Read);
            XmlReader reader = XmlReader.Create(fs);
        ...
        private MailMergeDataTable GetTestOrderTotals(int TestOrderId)
        {
            ...
            FileStream fs = new FileStream(_hostingEnvironment.WebRootPath + @"/Word/OrderTotals.xml", FileMode.Open, FileAccess.Read);               
            XmlReader reader = XmlReader.Create(fs);
